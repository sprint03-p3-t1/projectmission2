    ...
    if results:
        ...
        with col2:
            ...
            if results.get("chromadb"):
                ...
                # ChromaDB 시스템 결과 처리
                if isinstance(chromadb_result, dict) and "matched_records" in chromadb_result:
                    matched_records = chromadb_result["matched_records"]
                    semantic_docs = chromadb_result["semantic_docs"]
